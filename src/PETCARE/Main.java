...
public class Main {
	...
	public static void main(String[] args) {
		...
		Veterinary vet1 = new Veterinary(1, "Doctor Clarke", "(77) 99123-4567", "CRMV-BA 12345", "General Practitioner");
		...
		Animal lully = new Animal(1, "Lully", "Cat", "Maine Coon", 1, 7.0);
		Animal wendy = new Animal(2, "Wendy", "Cat", "Maine Coon", 1, 5.8);
		...
		Animal bambam = new Animal(1, "Bambam", "Dog", "Chihuahua", 2, 2.6);
